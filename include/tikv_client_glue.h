...
namespace tikv_client_glue {
#ifndef CXXBRIDGE1_STRUCT_tikv_client_glue$TransactionClient
#define CXXBRIDGE1_STRUCT_tikv_client_glue$TransactionClient
struct TransactionClient final : public ::rust::Opaque {
...
#endif // CXXBRIDGE1_STRUCT_tikv_client_glue$TransactionClient

#ifndef CXXBRIDGE1_STRUCT_tikv_client_glue$Transaction
#define CXXBRIDGE1_STRUCT_tikv_client_glue$Transaction
struct Transaction final : public ::rust::Opaque {
  ~Transaction() = delete;
...
#endif // CXXBRIDGE1_STRUCT_tikv_client_glue$Transaction

#ifndef CXXBRIDGE1_STRUCT_tikv_client_glue$Snapshot
#define CXXBRIDGE1_STRUCT_tikv_client_glue$Snapshot
struct Snapshot final : public ::rust::Opaque {
  ~Snapshot() = delete;
...
::rust::Box<::tikv_client_glue::Transaction> transaction_client_begin_optimistic_with_option(const ::tikv_client_glue::TransactionClient &client, ::std::uint32_t retry);
...
::rust::Vec<::KvPair> snapshot_batch_get(::tikv_client_glue::Snapshot &snapshot, const ::std::vector<::std::string> &keys);
